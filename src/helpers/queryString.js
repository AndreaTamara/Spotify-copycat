...
export const queryString =()=>{
    ...
    const scope = 'user-read-private user-read-email user-modify-playback-state user-read-recently-played streaming user-top-read user-library-read user-library-modify'
